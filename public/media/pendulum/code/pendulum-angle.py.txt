...
# Note ƒthat xerr and yerr can either be an array of the same length as x&y, or a single value
...
filename="graphs/Period vs. Angle of Pendulum Graph/data_period_vs_angle_henry.txt"
